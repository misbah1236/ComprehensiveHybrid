...
import com.mindtree.uiStore.HomeLifestyleUi;
import com.relevantcodes.extentreports.ExtentTest;

public class HomeLifestyle extends HomeLifestyleUi{
	WebDriver driver;
	Logger log;
	ExtentTest test;
	
	public HomeLifestyle(WebDriver driver, Logger log, ExtentTest test) throws Exception {
		this.driver = driver;
		this.test = test;
		this.log = log;
	}
	...
	{
		new Actions(driver).moveToElement(driver.findElement(HomeAndLifestyleButton)).build().perform();
		// select menu //
