...
import com.mindtree.uiStore.NewYearUi;
import com.relevantcodes.extentreports.ExtentTest;

public class NewYear extends NewYearUi {
	WebDriver driver;
	Logger log;
	ExtentTest test;
	
	public NewYear(WebDriver driver, Logger log, ExtentTest test) throws Exception {
		this.driver = driver;
		this.test = test;
		this.log = log;
	}
	...
	{
		Thread.sleep(3000);
		WebDriverSupport.click(driver, newyearButton,"Home page","newyear Gift button", log, test);
